...
run1input.wg         = 0.20      # volumetric water content top soil layer [m3 m-3]
run1input.w2         = 0.20      # volumetric water content deeper soil layer [m3 m-3]
...
run2 = model(run1input)
run2.input.du = 2.
run2.runmodel()

run3 = model(run1input)
run3.input.w2 = 0.21
run3.input.wg = 0.21
run3.runmodel()

run4 = model(run1input)
run4.input.S0 = 950.
run4.runmodel()

figure(1)
subplot(121)
plot(run1.out.t, run1.out.LE)
plot(run2.out.t, run2.out.LE)
plot(run3.out.t, run3.out.LE)
plot(run4.out.t, run4.out.LE)
subplot(122)
plot(run1.out.t, run1.out.LEpot)
plot(run2.out.t, run2.out.LEpot)
plot(run3.out.t, run3.out.LEpot)
plot(run4.out.t, run4.out.LEpot)

figure(2)
subplot(121)
plot(run1.out.t, run1.out.ra + run1.out.rs)
plot(run2.out.t, run2.out.ra + run2.out.rs)
subplot(122)
plot(run1.out.t, run1.out.qsurf - run1.out.q)
plot(run2.out.t, run2.out.qsurf - run2.out.q)

figure(3)
subplot(121)
plot(run1.out.t, run1.out.Q)
plot(run2.out.t, run2.out.Q)
plot(run3.out.t, run3.out.Q)
plot(run4.out.t, run4.out.Q)
