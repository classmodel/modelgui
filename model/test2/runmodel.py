...
run1input.runtime    = 60000.    # total run time [s]
...
run1input.dtheta     = 3.        # initial temperature jump at h [K]
...
run1input.dv         = 3.        # initial u-wind jump at h [m s-1]
run1input.gammav     = 0.003     # free atmosphere v-wind speed lapse rate [s-1]
